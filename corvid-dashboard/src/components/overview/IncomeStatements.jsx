    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (prevPeriod === 0) {
                    prevPeriod = 12; // Wrap around to December
                    prevYear = (parseInt(year) - 1).toString(); // Previous year
                }
                ...
                // Define category order based on the selected entity
                const categoryOrder = {
                ...
                // Reduce data into an object structure
                    ...
                    <table className="w-full table-fixed divide-y divide-gray-700 text-xs">
                        ...
                        <tbody>
                            {financialData.map(({ category, total_amount, subcategories }) => {
                                // Check if all subcategories are identical to the category
                                ...
                                return (
                                    <React.Fragment key={category}>
                                        ...
                                        <tr className="bg-gray-200 text-corvid-blue font-bold">
                                            ...
                                            >
                                                {/* Show dropdown arrow only if there are distinct subcategories */}
                                                {category}
                                        ...
                                        {/* **Subcategory Rows (Only show if they are distinct and dropdown is open)** */}
                                        {hasDistinctSubcategories &&
