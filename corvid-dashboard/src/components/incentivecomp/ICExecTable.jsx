...
const ICExecTable = () => {
    const [charges] = useState([
        { chargeCode: "1528-010", amount: "100,000.00", info: "EXTEND POP" },
        { chargeCode: "1326-060", amount: "155,182.00", info: "NEW CONTRACT" },
        { chargeCode: "1483-330", amount: "500,000.00", info: "FUNDING INCREASE" },
        { chargeCode: "1590-220", amount: "600,000.00", info: "EXTEND POP" },
        { chargeCode: "1326-090", amount: "167,182.00", info: "NEW CONTRACT" },
        { chargeCode: "1483-330", amount: "570,000.00", info: "FUNDING INCREASE" },
        { chargeCode: "1526-030", amount: "130,000.00", info: "EXTEND POP" },
        { chargeCode: "1378-050", amount: "N/A", info: "ADMIN" },
        { chargeCode: "1446-330", amount: "500,000.00", info: "FUNDING INCREASE" },
        { chargeCode: "1528-010", amount: "100,054.00", info: "EXTEND POP" },
        { chargeCode: "1640-210", amount: "155,182.00", info: "NEW CONTRACT" },
        { chargeCode: "1445-330", amount: "500,000.00", info: "FUNDING INCREASE" },
    ]);
                        ...
                        <div>
                            {selectedCharge && (
                                <div className="mb-4 p-4 bg-gray-200 border-gray-300 rounded">
                                    ...
                                    <p className="text-sm text-corvid-blue"><strong>Description:</strong> {selectedCharge.info}</p>
                                </div>
                            )}
                        </div>
                        <table className="w-full table-fixed divide-y divide-gray-700 text-xs">
